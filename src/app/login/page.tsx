  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      <div className="flex justify-center h-screen">
        <div
          className="hidden bg-cover lg:block lg:w-2/3 bg-[url('https://res.cloudinary.com/dfoa0w717/image/upload/v1715143772/campaign-creators-gMsnXqILjp4-unsplash_atssn5.jpg')] bg-cover bg-center"
