...
function SearchFunctionality({surveyResponseData, surveyID, title, formFields}:{surveyResponseData:any, surveyID:number,title:string, formFields:any}) {

  const [filteredResponses, setFilteredResponses] = useState([])
  
  useEffect(()=>{setFilteredResponses(surveyResponseData);},[])
  ...
  return (
    <>
      ...
      <AdminSurveyResponseList surveyResponseData={filteredResponses} surveyID={surveyID} title={title} formFields={formFields}/>
    </>
  )
}
